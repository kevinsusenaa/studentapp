...
import com.example.studentapp.AddCourse;
...
public class CourseAdapter  extends RecyclerView.Adapter<CourseAdapter.CardViewViewHolder> {
    ...
    @NonNull
    @Override
    public com.example.studentapp.adapter.CourseAdapter.CardViewViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_course_adapter, parent, false);
        return new com.example.studentapp.adapter.CourseAdapter.CardViewViewHolder(view);
    }

    @SuppressLint("ResourceAsColor")
    @Override
    public void onBindViewHolder(@NonNull final com.example.studentapp.adapter.CourseAdapter.CardViewViewHolder holder, int position) {
