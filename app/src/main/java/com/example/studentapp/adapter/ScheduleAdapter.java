...
import com.example.studentapp.Fragment.ScheduleFragment;
...
public class ScheduleAdapter extends RecyclerView.Adapter<ScheduleAdapter.CardViewViewHolder> {
    ...
    @Override
    public void onBindViewHolder(@NonNull final com.example.studentapp.adapter.ScheduleAdapter.CardViewViewHolder holder, final int position) {
    ...
    @NonNull
    @Override
    public com.example.studentapp.adapter.ScheduleAdapter.CardViewViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.schedule_adapter, parent, false);
        return new com.example.studentapp.adapter.ScheduleAdapter.CardViewViewHolder(view);
    }
