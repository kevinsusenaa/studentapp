...
import com.example.studentapp.adapter.CourseAdapter;
...
public class CourseData extends AppCompatActivity {
    ...
    private void showCourseData(ArrayList<Course> list) {
        CdataRV.setLayoutManager(new LinearLayoutManager(com.example.studentapp.CourseData.this));
        CourseAdapter courseAdapter = new CourseAdapter(com.example.studentapp.CourseData.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id == android.R.id.home){
            Intent intent = new Intent(com.example.studentapp.CourseData.this, AddCourse.class);
